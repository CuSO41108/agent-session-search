...
function workflow(workflowId: string): WorkflowDraftState {
  return {
    ...
    definition: { ...initialDefinition, workflowId }, messages: [], reply: "", error: undefined, runProgress: [], runContextDocument: "", contextDocument: "", runIds: [], createdAt: 1, updatedAt: 1,
  };
}
...
describe("useWorkflowDraft local objective drafts", () => {
