...
test("the package exposes an agent-recall-v2 Workflow MCP executable", async () => {
  ...
  assert.equal(manifest.bin["agent-recall-v2-workflow-mcp"], "bin/agent-recall-workflow-mcp.mjs");
